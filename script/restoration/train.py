...
# Based on the Marigold training script architecture but adapted for restoration tasks.
#
# --------------------------------------------------------------------------
...
if "__main__" == __name__:
    ...
    parser = argparse.ArgumentParser(
        description="Marigold : Image Restoration : Training"
    )
    parser.add_argument(
        "--config",
        type=str,
        default="config/train_marigold_restoration.yaml",
    ...
    # Validation dataset (optimized for speed)
    ...
    # Visualization dataset (same optimization)
    ...
    logging.debug(f"Trainer: MarigoldRestorationTrainer")
