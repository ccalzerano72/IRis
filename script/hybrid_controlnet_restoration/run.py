...
if "__main__" == __name__:
    ...
    parser.add_argument(
        ...
        help="Base SD2 model for VAE/text_encoder/scheduler. Default: sd2-community/stable-diffusion-2-1 "
             "(stabilityai/stable-diffusion-2 has been removed from HuggingFace; SD 2.1 uses identical "
             "VAE and text encoder components and produces equivalent results for inference)",
    )
    parser.add_argument(
        "--input_rgb_dir",
        type=str,
